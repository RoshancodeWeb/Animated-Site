...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-zinc-900 flex'>
        <div className='w-1/2 h-full px-20 pb-10 flex flex-col justify-between'>
             <div className='w-full text-6xl font-bold '>
                <h1 className='tracking-tighter leading-none'>EYE-</h1>
                <h1 className='tracking-tighter leading-none'>OPENING</h1>
             </div>
        ...
        <div className='w-1/2 h-full '>
            <div className='w-full text-6xl h-[10%] font-bold'>
                <h1 className='tracking-tighter '>PRESENTATION</h1>
             </div>
             <div className='w-full h-[90%] flex justify-between'>
                <div className='w-[40%] h-full '>
                      <div className='w-full h-fit pt-10'>
                        <p className='pb-8'>S:</p>
                        {
                        ["Instagram","Behance","Facebook","Linkedin"].map(
                        (value,index)=>(<a className='pb-1 cursor-pointer underline block' key={index}>{value}</a>))
                        }
                      </div>
                      <div className='w-full h-fit pt-10'>
                        <p className='pb-8'>S:</p>
